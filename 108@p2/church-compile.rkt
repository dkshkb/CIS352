...
(define (churchify e)
  (match e
    ...
    [`(zero? ,n) `((,(churchify n) (lambda (_) ,(churchify '#f))) ,(churchify '#t))]
    [`(= ,n0 ,n1) (churchify `(and (zero? (- ,n0 ,n1)) (zero? (- ,n1 ,n0))))]
    [`(let ,pairs ,e-body)
    ...
    [`(letrec ,pairs ,e-body)
     (churchify `(let ,(map (lambda (x) `(,(first x) (,Y (lambda (,(first x)) ,(churchify (second x)))))) pairs) ,e-body))]
    [`(+ ,n0 ,n1) `(lambda (f) (lambda (x) ((,(churchify n0) f) ((,(churchify n1) f) x))))]
    [`(add1 ,n) `(lambda (f) (lambda (x) (f ((,(churchify n) f) x))))]
    [`(sub1 ,n) `(lambda (f)
                   (lambda (x)
                     (((,(churchify n) (lambda (g) (lambda (h) (h (g f)))))
                       (lambda (u) x))
                      (lambda (u) u))))]
    [`(- ,n0 ,n1)
    `((,(churchify n1)
    ...
    [`(cdr ,list) `((,(churchify list)
                     (lambda (_) (lambda (x) x)))
                    (lambda (_) ,(churchify '#f)))]
    [`(and ,es ...) (churchify `(and-h ,es))]
    [`(and-h ,es) (if (empty? es) (churchify '#t)
                      `((,(churchify (car es)) (lambda (_) ,(churchify `(and-h ,(cdr es))))) (lambda (_) ,(churchify '#f))))]
    [`(or ,es ...) (churchify `(or-h ,es))]
    [`(or-h ,es) (if (empty? es) (churchify '#f)
                     `((,(churchify (car es)) (lambda (_) ,(churchify '#t))) (lambda (_) ,(churchify `(or-h ,(cdr es))))))]
    [`(lambda ,arg ,body)
